...
public class EditAddress extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((TextView) findViewById(R.id.addAddressTitle)).setText("Update address");
		((MaterialButton) findViewById(R.id.cancelAddressButton)).setVisibility(View.VISIBLE);
	}
	...
	public void updateStoreLocation() {
		...
		FirebaseFirestore.getInstance()
			...
			.addOnFailureListener(e -> {
				Toast.makeText(EditAddress.this, "Error saving the address", Toast.LENGTH_SHORT)
					.show();
				uploading = false;
			});
	}
